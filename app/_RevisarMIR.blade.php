                        ...
                        <div class="tab-pane fade" id="nav-actividades" role="tabpanel" aria-labelledby="tab-actividades" tabindex="0">
                            <div class="row">
                                ...
                                <div class="col-3 mb-1 FormUsr FontMsg mt-3">
                                    ...
                                    <input type="text" class="TextBoxUsrReadOnly w-100 H-50 text-center" id="id_componenteactividad" readonly>
                                </div>
                            ...
                            <div id="actividadesuno">
                                <div class="row">
                                    ...
                                    <div class="col-3 mb-1 FormUsr FontMsg mt-3">
                                        ...
                                        <input type="text" class="TextBoxUsrReadOnly w-100 H-50 text-center" id="id_actividad">
                                    </div>
                                    <div class="col-8 mb-1 FormUsr FontMsg mt-3">
                                    ...
                                    <div class="col-2 mb-1 FormUsr FontMsg mt-3">
                                        ...
                                        <input type="text" class="TextBoxUsr w-100 H-50" id="claveindicador_actividad">
                                    </div>
                                    <div class="col-10 mb-1 FormUsr FontMsg mt-3">
                                    ...
                                    <div class="col-3 mb-1 FormUsr FontMsg mt-3">
                                        ...
                                        <textarea class="TextBoxUsr w-100 H-50" id="variable1_actividad" required maxlength="300" rows="4"></textarea>
                                    </div>
                                    <div class="col-3 mb-1 FormUsr FontMsg mt-3">
                                        <label for="variable2_actividad" class="form-labelUsr4">Variable 2 (V2)</label>
                                        <textarea class="TextBoxUsr w-100 H-50" id="variable2_actividad" required maxlength="300" rows="4"></textarea>
                                    </div>
                                    <div class="col-3 mb-1 FormUsr FontMsg mt-3">
                                        <label for="variable3_actividad" class="form-labelUsr4">Variable 3 (V3)</label>
                                        <textarea class="TextBoxUsr w-100 H-50" id="variable3_actividad" required maxlength="300" rows="4"></textarea>
                                    </div>
