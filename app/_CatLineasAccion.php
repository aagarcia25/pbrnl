                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 mt-2">
                                <label for="select_estrategia" class="form-label">Estrategia</label>
                                <select id="select_estrategia" class="selectpicker show-tick form-control" title="Seleccione..." data-none-results-text="No se encontraron resultados de {0}" data-show-tick="true" data-size="7" data-live-search="true" data-actions-box="true" required>
                                </select>
                            </div>
                        </div>
                        <!-- Botones de accion -->
                            ...
                            <table id="table" class="table table-striped table-hover">
                                <thead>
                                    <tr class="table-header text-center">
                                        ...
                                        <th scope="col" width="10%">Id LA</th>
