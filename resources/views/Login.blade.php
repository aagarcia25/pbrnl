 ...
 <div class="container-fluid w-100">
                                ...
                                <div class="vh-5 row text-center align-items-center justify-content-center py-0">
                                    ...
                                    <div class="col-auto">
                                        <div class="mb-4" style="margin-left: -25px">
                                            <input type="text" id="id_usuario" class="form-control UserTextBox text-uppercase" name="id_usuario" placeholder="Usuario" />
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="Modal" tabindex="-1">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header TituloMsg">
                    <h5 class="modal-title ">Mesaje</h5>
