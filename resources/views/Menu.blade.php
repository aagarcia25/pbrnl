...
<div class="container FontMenuInicio" style="margin-top: 7%">
    <div class="row my-5">
        ...
        <div class="col-lg-4">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <a @if (session('admin_evalua') == 1) href="/publicMenuAdmin" @else href="#" @endif>        
        ...
        <div class="col-lg-4">
            <div class="d-flex align-items-center justify-content-center">
                <a @if (session('catalogos_pbr') == 1) href="/publicCatalogos" @else href="#" @endif class="d-flex align-items-center justify-content-center">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-4">
            <div class="d-flex align-items-center justify-content-center">
                <a @if (session('admin_mir') == 1) href="/publicMenuMIR" @else href="#" @endif class="d-flex align-items-center justify-content-center">
