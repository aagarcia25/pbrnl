...
<nav class="navbar navbar-expand-lg navbar-white bg-white static-top">
        <div class="container w-100">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown_usuario">
                    <img src="img/iconousuario2.svg" width="50" alt="Usuario" class="border-none" type="button" id="dropdownMenuButton" data-mdb-toggle="dropdown" aria-expanded="false">
                    <ul class="dropdown-menu mt-1 pt-3" aria-labelledby="dropdownMenuButton">
                        <li class="dropdown-item UsuarioBG fw-bold text-uppercase">
                            @php echo session('id_usuario'); @endphp<br>@php echo session('nombre') . " " . session('ap_paterno'); @endphp
                        </li>
                        <li><a class="dropdown-item BtnLogout text-center" href="/Logout">Cerrar sesión</a></li>
